...
# nnUNet FIVE_CROP training (circle cropping data, 5-fold CV, fold 0). GPU: CUDA:1

CONDA_ENV="nnunet"

TRAIN_IMAGES_DIR="/home/yuganlab/Desktop/Haozhe/MICCAI2026/datasets/masks/Crop/train/Original"
TRAIN_MASKS_DIR="/home/yuganlab/Desktop/Haozhe/MICCAI2026/datasets/masks/Crop/train/Ground truth"
TEST_IMAGES_DIR="/home/yuganlab/Desktop/Haozhe/MICCAI2026/datasets/masks/Crop/test/Original"
TEST_MASKS_DIR="/home/yuganlab/Desktop/Haozhe/MICCAI2026/datasets/masks/Crop/test/Ground truth"

DATASET_ID="007"
DATASET_NAME="FIVE_CROP"
...
echo "=========================================="
echo "Train: ${DATASET_NAME} (Circle Cropping)"
...
echo ""
echo "=========================================="
echo "Step 1: Convert data to nnUNet format (preprocessed)"
echo "=========================================="
